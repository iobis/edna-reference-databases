...
Example:
    ...
    python scripts/download_ncbi_accessions.py --email you@example.com --preset 16s_prokaryotic_slim
    python scripts/download_ncbi_accessions.py --email you@example.com --preset 16s_prokaryotic_refseq
